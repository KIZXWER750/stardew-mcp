...
- 계획은 `goals-v1` 문서의 schema 2에 저장되며 이전 schema 1 목표는 자동 변환됩니다.
...
- 3차는 계획 단계를 실행하지 않습니다. 계획 생성이나 사용자 질문 답변만으로 구매·농사·판매 함수가 호출되지 않습니다.
...
- 2차에는 경제 분석이 포함됩니다. 전략 선택, 일일 계획, 수익 행동의 자동 실행은 포함되지 않습니다.
