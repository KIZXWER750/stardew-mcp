...
if ($version -ne '1.10.4') { throw "Wrong source version: $version" }
...
$backup = Join-Path (Split-Path $src -Parent) ('StardewMCP-before-1.10.4-' + (Get-Date -Format 'yyyyMMdd-HHmmss'))
...
Write-Host '1.10.4 installed. AI tool and observation budgets increased from 60 to 180; request window increased to 20 minutes. Restart Steam/SMAPI; F6 opens commands, F7 cancels.'
