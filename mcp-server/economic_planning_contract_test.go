...
func TestPhaseThreePlanningContract(t *testing.T) {
	...
	for _, required := range []string{"MISSING_ACTION_AUTHORIZATION", "StateFingerprint", "GoalActionAuthorized", "RefreshGoalPlanFreshness", "start_goal_plan_execution", "USER_INPUT_REQUIRED", "판매할 수확물을 준비한 뒤 재개", "existing_crop_cycle", "tend_existing_crops", "ExistingCropFingerprint", "NormalizeGrowthDays", "MaxPlanSteps", "HasSafeShape"} {
